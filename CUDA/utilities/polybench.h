...
/*
 * polybench.h: trimmed PolyBench/C header for this CUDA example.
 * Removed optional PAPI and OpenMP-specific instrumentation to keep
 * the header minimal for the provided CUDA workloads.
 */
...
/* Macros to reference an array. Generic for heap and stack arrays (C99). */
...
/* Performance-related instrumentation. By default nothing; POLYBENCH_TIME enables timing. */
